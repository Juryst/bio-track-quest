    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          "normal-border": "hsl(var(--status-normal-border))",
          ...
          "unknown-border": "hsl(var(--status-unknown-border))",
        },
        "card-border": {
          danger: "hsl(var(--card-border-danger))",
          warning: "hsl(var(--card-border-warning))",
          normal: "hsl(var(--card-border-normal))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
